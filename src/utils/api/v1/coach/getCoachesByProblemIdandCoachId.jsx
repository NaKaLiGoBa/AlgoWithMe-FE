...
async function getCoachesByProblemIdandCoachId(problemId, coachId) {
  const apiUrl = `/api/v1/problems/${problemId}/coaches${coachId}`;

  return call(apiUrl, 'GET');
}

export default getCoachesByProblemIdandCoachId;
